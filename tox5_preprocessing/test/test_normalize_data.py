...
from TOX5.endpoints.reader import MetaDataReader, DataReader
...
class AddedNormalizationsTest(TestCase):
    ...
    def test_casp_additional_normalization(self):
        ...
        casp_meta_data = MetaDataReader('./test_data/annotation.xlsx', casp_data)
        casp_meta_data.read_meta_data()
