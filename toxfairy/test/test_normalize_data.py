...
class MainNormalizationsTest(TestCase):
    ...
    def test_remove_outliers_by_quantiles(self):
        ...
        assert_frame_equal(expected, self.ctg_data.normalized_df, check_index_type=False,
...
class AddedNormalizationsTest(TestCase):
    ...
    def test_clean_dna_raw(self):
        test = {
            'cells': ['A549', 'A549', 'A549', 'A549', 'A549', 'A549', 'A549', 'A549', 'A549', 'A549', 'A549', 'A549'],
            'replicates': ['S1', 'S1', 'S1', 'S2', 'S2', 'S2', 'S3', 'S3', 'S3', 'S4', 'S4', 'S4'],
            'time': ['6H', '6H', '6H', '6H', '6H', '6H', '6H', '6H', '6H', '6H', '6H', '6H'],
            'Description': ['DAPI', 'H2AX', '8OHG', 'DAPI', 'H2AX', '8OHG', 'DAPI', 'H2AX', '8OHG', 'DAPI', 'H2AX',
                            '8OHG'],
        ...
        self.assertTrue(np.isnan(ohg_data.raw_data_df.loc[0, 'A1']))
        self.assertTrue(np.isnan(ohg_data.raw_data_df.loc[3, 'A1']))
        self.assertTrue(np.isnan(ohg_data.raw_data_df.loc[0, 'B1']))
        self.assertTrue(np.isnan(ohg_data.raw_data_df.loc[3, 'B1']))
